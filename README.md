...
#> [13] "https://google.com:8080/"
set_query(urls, "foo=bar")
#>  [1] "/"                                            
#>  [2] "//google.com"                                 
#>  [3] "file:///?foo=bar"                             
#>  [4] "http://google.com/?foo=bar"                   
#>  [5] "http://google.com/path?foo=bar"               
#>  [6] "http://google.com/path?foo=bar"               
#>  [7] "http://google.com:1234/path?foo=bar"          
#>  [8] "http://google.com:8080/path?foo=bar#frag"     
#>  [9] "http://google.com:8080/path?foo=bar#frag"     
#> [10] "http://user@google.com/path?foo=bar"          
#> [11] "http://user:pass@google.com:8000/path?foo=bar"
#> [12] "svn+ssh://my.svn.server/repo/trunk?foo=bar"   
#> [13] "https://google.com:8080/?foo=bar"
